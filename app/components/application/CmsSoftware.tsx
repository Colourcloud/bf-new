...
const CmsSoftware = () => {
    return (
        ...
        <section className="builtflat-section">
            <div className="container w-11/12 xl:w-2/3 mx-auto rounded-lg shadow-md bg-white border-gray-200 border p-8 md:p-10">
                <div className="section-text flex flex-col gap-4 w-full md:w-3/5">
                    ...
                    <p className='font-light text-lg'>Have experience with a CMS software already? Builtflat can develop sites with a majority of the popular systems available. Allowing your team to keep using what they&apos;re comfortable with.</p>
                </div>
