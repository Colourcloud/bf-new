            ...
            <div className="section-wrapper mx-auto relative max-w-[1920px] flex flex-col lg:flex-row">
               ...
               <div className="section-text flex flex-col gap-8 w-full lg:w-[40%] justify-center px-4 lg:px-16 py-16">
                    ...
                    <div className="section-text-group flex flex-col gap-3">
                        ...
                        <p className='font-light text-base text-white'>We love it when our clients have their say and encourage you to have your own input on every design decision we make. You know your brand best, that&apos;s why we listen to what you have to say.</p>
                    </div>
               </div>
            </div>
        </section>
