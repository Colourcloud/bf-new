        ...
        <div className="site-wrapper">
            ...
            <div className="questions-container max-w-4xl mx-auto mt-12">
                ...
                <AccordionItem value="item-1">
                    <AccordionTrigger>Why is this better than the basic website analysis?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-2">
                    <AccordionTrigger>Do I need this analysis?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger>If I have questions, is there someone I can talk to?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger>Do I have to install anything?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-5">
                    <AccordionTrigger>What&apos;s the need for website performance anyways?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-6">
                    <AccordionTrigger>I don&apos;t have anyone who could help with these improvements & fixes. Can Builtflat?</AccordionTrigger>
                    <AccordionContent>
