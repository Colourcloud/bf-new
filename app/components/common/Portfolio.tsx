        ...
        <section className="builtflat-section pt-16 pb-40 h-full bg-[--dark-background-color]">
            <div className="site-wrapper">
                <div className="section-text flex flex-col gap-8 w-full xl:w-3/5 md:mx-auto text-left md:text-center items-start md:items-center spaced-p">
                    ...
                    <p className='text-xl font-light text-white'>We&apos;ve worked with some top-tier businesses to bring their ideas to life. These aren&apos;t just websites. They&apos;re polished designs aimed and developed to hit goals, improve productivity and impress clients.</p>
