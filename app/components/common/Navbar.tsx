                    ...
                    <div className='nav-container flex flex-row justify-between h-16'>
                        <div className='nav-content-left flex flex-row gap-16 items-center'>
                            ...
                            <ul className='flex flex-row gap-16'>
                                    <li className='text-white relative toggle-dropdown'>
                                        ...
                                        <div className="nav-dropdown-menu p-8 flex flex-col gap-8">
                                            ...
                                            <Link href="/mobile-development" className='nav-dropdown-item relative'>
                                                <div className='text-black flex flex-row gap-4'>
                                                    ...
                                                    <div className='flex flex-col'>
                                                        <h4 className='text-base font-semibold'>Mobile Development</h4>
                        ...
                        <div className='nav-content-right flex items-center'>
                            <Link className="toggle-contact px-4 py-2 text-sm rounded-md button-behaviour relative background-purple text-white flex flex-row items-center gap-2 font-medium" href="/contact"><IoSendSharp className="rotate-[-45deg]"></IoSendSharp>Start Now</Link>
                        </div>
                    </div>
                </div>
            </div>
