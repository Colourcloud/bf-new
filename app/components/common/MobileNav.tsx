        ...
        <div>
            ...
            <div className="site-wrapper">
                ...
                <div className="w-1/3 flex justify-end">
                    <a className="toggle-contact px-4 py-2 text-sm rounded-md button-behaviour relative background-purple text-white flex flex-row items-center gap-2 font-medium" href="/contact">Start Now</a>
                </div>
                </div>
            </div>
            <div className={`sidenav w-10/12 h-full z-[9999] fixed left-0 top-0 bottom-0 lg:hidden ${isSideNavActive ? 'active' : ''}`}>
                <div className='sidenav-container flex flex-col gap-10 p-8'>
                    ...
                    <div className="sidenav-contact sticky bottom-2 w-full left-0 bg-[#212122]">
                        <a href="/contact" className='bg-white text-black p-3 text-center text-sm w-full block rounded-md flex flex-row items-center justify-center gap-2'><span><IoSendSharp className="rotate-[-45deg] text-base"></IoSendSharp></span>Contact us Today</a>
                    </div>
                </div>
            </div>
        </div>
