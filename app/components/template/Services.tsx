            ...
            <div className="site-wrapper">
                ...
                <section className='mobile-services-layout pb-40 visible md:invisible flex gap-16 flex-col md:hidden'>
                    <div className="content-block flex flex-col gap-8">
                        <AnimateOnScroll>
                            <Image src={images[0]} alt="yes" className='w-full rounded-lg template-service-image' width="1200" height="1200"></Image>
                        </AnimateOnScroll>
                    ...
                    <div className="content-block flex flex-col gap-8">
                        <AnimateOnScroll>
                            <Image src={images[1]} alt="yes" className='w-full rounded-lg template-service-image' width="1200" height="1200"></Image>
                        </AnimateOnScroll>
                        <div className="content-text flex flex-col gap-6">
                    ...
                    <div className="content-block flex flex-col gap-8">
                        <AnimateOnScroll>
                            <Image src={images[2]} alt="yes" className='w-full rounded-lg template-service-image' width="1200" height="1200"></Image>
                        </AnimateOnScroll>
                        <div className="content-text flex flex-col gap-6">
