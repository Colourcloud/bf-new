                ...
                <div className='overflow-hidden'>
                    ...
                    <section className="builtflat-section relative z-10">
                        ...
                        <div className="partner-images flex flex-col lg:flex-row gap-5 py-12">
                            <Image src={PartnerImageOne} alt="Group of architects looking at a house layout in an office" className='relative z-20 rounded-md w-full lg:w-2/4' width='1200' height='500' priority  />
                            <Image src={PartnerImageTwo} alt="Two web designers working in an office with laptops while a person is walking in the background" className='relative z-20 rounded-md w-full lg:w-2/4' width='1200' height='500' priority />
                        </div>
                    </section>
                    </div>
                </div>
