        ...
        <div className='py-20 md:py-40 bg-[--background-light]'>
            <div className="site-wrapper">
                <div className="section-text w-full md:w-2/3 flex flex-col gap-8 items-start">
                    ...
                    <p className='text-2xl font-light text-[#7d7d7d]'>To meet the goals your business wants, it takes a team of passionate people to overcome tough challenges. Meet the team who can make that happen</p>
                </div>
